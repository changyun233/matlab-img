...
%imwrite(uint8(proc_graph),'C:\\Users\\HJSF\\Desktop\\Dynamic\\matlab\\PP_chapter_3\\figure3.1(º”√‹).jpg');
figure;
...
%imwrite(uint8(image_hide_decode),'C:\\Users\\HJSF\\Desktop\\Dynamic\\matlab\\PP_chapter_3\\figure3.1(Ω‚¬Î).jpg');
figure;
